...
if ( class_exists( 'WP_Customize_Control' ) ) {
	...
	class Customizer_Dropdown_Select2_Control extends WP_Customize_Control {
		...
		public function enqueue() {
			...
			wp_enqueue_script( 'rttheme-custom-controls-js', get_template_directory_uri() . '/assets/customize/js/customizer.js', [ 'rttheme-select2-js' ], '1.2', true );
			wp_enqueue_style( 'rttheme-custom-controls-css', get_template_directory_uri() . '/assets/customize/css/customizer.css', [], '1.1', 'all' );
