...
namespace RT\NewsFit\NewsFitCore\Customize;
...
class FieldManager {
	...
	public static function customizer_switch_select_control_script() {
		wp_enqueue_script( 'newsfit-customizer-condition', get_template_directory_uri() . '/assets/customize/js/customizer-condition.js', [ 'jquery', 'customize-controls' ], '1.0', true );
