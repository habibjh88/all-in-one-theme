...
if ( class_exists( 'WP_Customize_Control' ) ) {
	class Customizer_Alfa_Color extends WP_Customize_Control {
		...
		public function enqueue() {
			wp_enqueue_style( 'rttheme-custom-controls-css', get_template_directory_uri() . '/assets/customize/css/customizer.css', [ 'wp-color-picker' ], '1.0', 'all' );
			wp_enqueue_script( 'rttheme-custom-controls-js', get_template_directory_uri() . '/assets/customize/js/customizer.js', [ 'jquery', 'wp-color-picker' ], '1.0',
				true );
		}
