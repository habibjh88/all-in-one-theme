...
if ( class_exists( 'WP_Customize_Control' ) ) {
	...
	class Customizer_Google_Fonts_Controls extends WP_Customize_Control {
		...
		public function enqueue() {
			wp_enqueue_script( 'rttheme-select2-js', get_template_directory_uri() . '/assets/customize/js/select2.min.js', [ 'jquery' ], '4.0.6', true );
			wp_enqueue_script( 'rttheme-typography-controls-js', get_template_directory_uri() . '/inc/NewsfitCore/customize/custom-controls/typography/assets/typography.js', [ 'rttheme-select2-js' ], '1.2', true );
			wp_enqueue_style( 'rttheme-select2-css', get_template_directory_uri() . '/assets/customize/css/select2.min.css', [], '4.0.6', 'all' );
		}
		...
		public function rttheme_getGoogleFonts( $count = 30 ) {
			...
			if ( $_font_path === 'url' ) {
				$fontFile = get_template_directory_uri() . '/inc/NewsfitCore/customize/custom-controls/typography/google-fonts/google-fonts-popularity.json';
			...
			// add_filter('homlisti_customizer_fonts_change', function (){ $fontFile = get_template_directory_uri() . '/inc/NewsfitCore/customize/custom-controls/typography/google-fonts/google-fonts-alphabetical.json'; $get_content = file_get_contents($fontFile); return $get_content;});
		}
	}
}
