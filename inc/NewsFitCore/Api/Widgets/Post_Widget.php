...
namespace RT\NewsFit\NewsFitCore\Api\Widgets;
	...
	public function form( $instance ) {
		...
		$fields = [
			...
			'layout'         => [
				...
				'type'    => 'select',
				'options' => [
					'blog-list-style'      => __( 'List', 'homlisti-core' ),
					'blog-grid-style'      => __( 'Grid', 'homlisti-core' ),
					'blog-big-first-style' => __( '1st Big Other\'s list - 1', 'homlisti-core' ),
					'blog-big-first-style style2' => __( '1st Big Other\'s list - 2', 'homlisti-core' ),
				]
			],
			'query_title'    => [
			...
			'orderby'        => [
				...
				'options' => [
					...
					'popular'       => __( 'Popular Post', 'homlisti-core' ),
				]
			],
			'order'          => [
			...
			'content_visibility' => [
				...
				'type'    => 'select',
				'options' => [
					'first' => __( 'Only First Post', 'homlisti-core' ),
					'all'   => __( 'All Posts', 'homlisti-core' ),
					'hide'  => __( 'Hide for all', 'homlisti-core' ),
				]
			],
			'meta_style'         => [
